...
// public PhotonCamera[] photonCameras = new
// PhotonCamera[VisionConstants.kPhotonCameras.length];
// public PhotonPoseEstimator[] photonPoseEstimators = new
// PhotonPoseEstimator[VisionConstants.kPhotonCameras.length];
