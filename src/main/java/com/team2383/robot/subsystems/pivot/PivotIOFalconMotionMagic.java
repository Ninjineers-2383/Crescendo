...
public class PivotIOFalconMotionMagic implements PivotIO {
    ...
    public PivotIOFalconMotionMagic() {
    ...
    public void updateInputs(PivotIOInputs inputs) {
        ...
        inputs.currentDesiredAngle = leftMotor.getClosedLoopReference().getValue() - positionOffset;
    }
