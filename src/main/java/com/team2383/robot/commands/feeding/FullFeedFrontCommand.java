...
public class FullFeedFrontCommand extends ParallelCommandGroup {

    public FullFeedFrontCommand(ShooterSubsystem shooter, IndexerSubsystem indexer, PivotSubsystem pivot,
