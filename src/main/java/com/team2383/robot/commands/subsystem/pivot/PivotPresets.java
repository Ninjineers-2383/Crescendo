...
public class PivotPresets {
    ...
    public static double ZERO_BACK = Math.toRadians(180);
    ...
    public static double SUBWOOFER = Math.toRadians(123);
    public static double SUBWOOFER_BACK = Math.toRadians(57);
