...
public class PivotPresets {
    ...
    public static double FEED_FRONT = Math.toRadians(180 - 36);

    public static double SCORE_AMP = Math.toRadians(-55);

    public static double SCORE_TRAP = Math.toRadians(55);
