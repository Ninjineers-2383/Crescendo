...
public class FullAutoCommand extends SequentialCommandGroup {
    ...
    // state.poseMeters = new Pose2d(state.poseMeters.getX(), 8.02 -
    ...
    public FullAutoCommand(DrivetrainSubsystem drivetrain, ElevatorSubsystem elevator, WristSubsystem wrist,
        ...
        // put("Feed Cone", new BlizzardCommand(elevator, wrist,
        // BlizzardPresets.GROUND_INTAKE)
        // .alongWith(new FeederVoltageCommand(feeder, () -> -0.5, false)));

        // put("Feed Cube", new BlizzardCommand(elevator, wrist,
        // BlizzardPresets.GROUND_INTAKE)
        // .alongWith(new FeederVoltageCommand(feeder, () -> -0.5, true)));

        // put("Retract", new BlizzardCommand(elevator, wrist,
        // BlizzardPresets.CONE_CHUTE)
        // .alongWith(new FeederVoltageCommand(feeder, () -> -0.15,
        // true).withTimeout(0.02)));
