...
public class CubeCleanConeEngage extends SequentialCommandGroup {
    public CubeCleanConeEngage(DrivetrainSubsystem drivetrain, ElevatorSubsystem elevator, WristSubsystem wrist,
